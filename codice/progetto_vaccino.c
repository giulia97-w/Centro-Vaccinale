...
//anamnesi 
    ...
    double p_zero_accettazione_a = 1 / (  ((pow((SERVERS_ANAMNESI*ro_a),SERVERS_ANAMNESI)) / ((1-ro_a)*(fattoriale(SERVERS_ANAMNESI))) ) + 1 + (ro_a*SERVERS_ANAMNESI) + ((pow((SERVERS_ANAMNESI*ro_a),2)) / ((fattoriale(2))) + (ro_a*SERVERS_ANAMNESI) + ((pow((SERVERS_ANAMNESI*ro_a),3)) / ((fattoriale(3))) + ((pow((SERVERS_ANAMNESI*ro_a),4)) / ((fattoriale(4))) ))));
