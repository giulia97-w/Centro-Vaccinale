...
int numCenters = 5;
    ...
    while(((strcmp(simulation,"finite")==0) && ((event[0].current < STOP) || ((accettazione.number + anamnesi.number + inoculazione.number + inoculazione_attenuato.number) > 0))) || ((strcmp(simulation,"infinite")==0) && (batch(currentBatch, 256)))){
